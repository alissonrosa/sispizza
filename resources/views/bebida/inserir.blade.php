...
<div class="container-fluid">
    ...
    <h3 class="page-header" style="font-size: 20px; font-family: Arial;">Adicionar Bebida</h3>
</br>
<div id="msg"></div>


<form method="POST" action="{{route('bebida.store')}}" id="form">
